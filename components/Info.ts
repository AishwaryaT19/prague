...
export const projects: projectTypes[] = [
  {
    imgUrl: "/assests/images/main.jpg",
    projectYear: 2010,
    projectName: "poolscape villa",
    projectDesc:
    ...
    projectLocation: "poolscape villa",
...
export const place = "Chennai,India";
export const main = "Awesome Design for the Vorokhta Hub";
export const objective =
  "The main objective of the project - transformation of Vorokhta City in innovative SMART CITY (village) and tourist center.";
export const abHead = "Break out of your routine with a global perspective";
...
export const yearsOfExpBackground = "/assests/images/main.jpg";
export const projectSubHead = "Make it with Passion";
export const aboutBackground = "/assests/images/about.jpg";
export const aboutMain = "I'm focus on creative work and shared knowledge";
export const descHead = "Make with love all what i do.";
...
export const serHead = "This is what I do.";
export const services = [
  {
    serviceIcon: RiCompasses2Line,
...
export const servicePic = "/assests/images/side.jpg";
export const timeline = "Awards that I have.";
...
export const testimonialHeading = "They love us";
